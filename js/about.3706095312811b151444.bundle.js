...
/* harmony import */ var _about_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
/* harmony import */ var _partials_partials__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
...
/* harmony import */ var _team_data_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
var _team_data_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(6, 1);
...
var loadEmployeeDetails = function loadEmployeeDetails(id, modal, employee_el) {
  if (modal === "true") {
    ...
    employee_el.querySelector(".bio-text").textContent = "".concat(_team_data_json__WEBPACK_IMPORTED_MODULE_3__[id].bio);
    Object.entries(_team_data_json__WEBPACK_IMPORTED_MODULE_3__[id].links).map(function (_ref) {
  ...
  employee_el.querySelector(".employee-name").textContent = "".concat(_team_data_json__WEBPACK_IMPORTED_MODULE_3__[id].name);
  employee_el.querySelector(".employee-occupation").textContent = "".concat(_team_data_json__WEBPACK_IMPORTED_MODULE_3__[id].occupation);
  employee_el.querySelector(".employee-img").style.backgroundImage = "url('./assets/team/".concat(_team_data_json__WEBPACK_IMPORTED_MODULE_3__[id].imageURL, "')");
};
...
var loadEmployee = Object.entries(_team_data_json__WEBPACK_IMPORTED_MODULE_3__).map(function (_ref3, i) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=about.3706095312811b151444.bundle.js.map